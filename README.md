...
기본 Detector는 GA4/GTM입니다. Mixpanel/Meta/PostHog/Amplitude를 탐지하려면 `detectors`에 명시적으로 추가합니다. Production overlay는 Local Node Runtime이 같은 endpoint로 Manifest를 제공합니다. 다른 endpoint를 사용할 때는 `manifestEndpoint`를 지정합니다.
